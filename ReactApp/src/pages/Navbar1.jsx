...
export function Navbar1() {
  ...
  <Nav.Item>
    <Nav.Link onClick={() => navigate("/FlightSearch")}>FlightSearch</Nav.Link>
  </Nav.Item>
) : null} 
{userDetails.roleId==1 ? (
  <Nav.Item>
    <Nav.Link onClick={() => navigate("/users")}>UsersList</Nav.Link>
  </Nav.Item>
) : null}
...
{userDetails.userName ? (
        ...
        {/* {userDetails.userName ? (
   <Nav.Item>
          <Nav.Link onClick={() => navigate("/profile")}>Edit Details</Nav.Link>
        </Nav.Item>
        ) : null} */}
